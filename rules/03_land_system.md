...
- **リニア計算規則**: ブロック全体の合計産出は **`1マスの産出 (ベース 5) × マス数`** で計算される。
...
## 🎲 🔍 配置済みブロックの「コスト1🔥消費 ✕ 2D6ダイス探索判定」

| 2D6合計出目 | 判定 | 探索発見効果 |
| :---: | :---: | :--- |
| **2 〜 4** | **不発** | 通常の土地のまま（特別な資源は見つからず） |
| **5 〜 8** | **通常発見** | 通常のボーナス資源（穀物 🌾+15 / 鉱脈 🧱+15 / 高級木材 🧱+20）が出現 |
| **9 〜 11** | **豊かな土地** | レアボーナス資源（貴金属 🧱+10, ✨+5 / オアシス果実 🌾+15, ✨+10）が出現 |
| **12 (ゾロ目6)** | **遺跡・フロンティア** | 遺跡イベント / フロンティア地形が露出 |
