    ...
    constructor(dependencies = {}) {
        ...
        this.boardDomainAdapter = dependencies.boardDomainAdapter
            || (BoardDomainAdapterClass ? new BoardDomainAdapterClass({
                ...
                zoneConversionDefinitions: Object.prototype.hasOwnProperty.call(dependencies, 'zoneConversionDefinitions')
                    ? dependencies.zoneConversionDefinitions
        ...
        if (dependencies.trialTimingAuthorityService) {
            ...
            this.trialTimingAuthorityService = new TrialTimingAuthorityServiceClass({
                schedule: { trial1: 15, trial2, trial3 }
            });
