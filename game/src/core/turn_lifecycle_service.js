...
export class TurnLifecycleService {
    ...
    _initializeNextTurn() {
        ...
        // Stage progression is no longer a Verse/schedule threshold side effect.
        // Trial settlement authorizes it, and the Trial presentation exit path
        // performs the physical expansion only after Trial-specific cleanup.
