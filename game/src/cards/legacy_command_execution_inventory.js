...
const DOMAIN_ACTION_MIGRATION_BLOCKER = Object.freeze({
    BOARD_MUTATION_API_MISSING: "BOARD_MUTATION_API_MISSING",
    ZONE_CONVERSION_DEFINITION_MISSING: "ZONE_CONVERSION_DEFINITION_MISSING",
    ZONE_CONVERSION_SEMANTIC_EXTENSION_REQUIRED: "ZONE_CONVERSION_SEMANTIC_EXTENSION_REQUIRED",
    SPECIAL_BLOCK_SEMANTIC_MISMATCH: "SPECIAL_BLOCK_SEMANTIC_MISMATCH",
    PROJECT_DOMAIN_MISSING: "PROJECT_DOMAIN_MISSING",
    EXPLORATION_RESOLVER_OWNERSHIP_PENDING: "EXPLORATION_RESOLVER_OWNERSHIP_PENDING"
});
...
const DOMAIN_ACTION_MIGRATION_BLOCKER_BY_ID = Object.freeze({
    CMD_TRANSMUTE_GOLDEN: DOMAIN_ACTION_MIGRATION_BLOCKER.BOARD_MUTATION_API_MISSING,
    CMD_RESETTLEMENT: DOMAIN_ACTION_MIGRATION_BLOCKER.ZONE_CONVERSION_SEMANTIC_EXTENSION_REQUIRED,
    CMD_WETLAND_RECLAMATION: DOMAIN_ACTION_MIGRATION_BLOCKER.BOARD_MUTATION_API_MISSING,
    CMD_IRRIGATION: DOMAIN_ACTION_MIGRATION_BLOCKER.BOARD_MUTATION_API_MISSING,

    CMD_PASTORAL_FARM: DOMAIN_ACTION_MIGRATION_BLOCKER.SPECIAL_BLOCK_SEMANTIC_MISMATCH,
    CMD_SAWMILL: DOMAIN_ACTION_MIGRATION_BLOCKER.SPECIAL_BLOCK_SEMANTIC_MISMATCH,
    CMD_QUARRY: DOMAIN_ACTION_MIGRATION_BLOCKER.SPECIAL_BLOCK_SEMANTIC_MISMATCH,
    CMD_MINE: DOMAIN_ACTION_MIGRATION_BLOCKER.SPECIAL_BLOCK_SEMANTIC_MISMATCH,
    CMD_STABLE: DOMAIN_ACTION_MIGRATION_BLOCKER.SPECIAL_BLOCK_SEMANTIC_MISMATCH,
    CMD_LIME_KILN: DOMAIN_ACTION_MIGRATION_BLOCKER.SPECIAL_BLOCK_SEMANTIC_MISMATCH,
    CMD_MARKET: DOMAIN_ACTION_MIGRATION_BLOCKER.SPECIAL_BLOCK_SEMANTIC_MISMATCH,
    CMD_DEPOT: DOMAIN_ACTION_MIGRATION_BLOCKER.SPECIAL_BLOCK_SEMANTIC_MISMATCH,
    CMD_WORKSHOP: DOMAIN_ACTION_MIGRATION_BLOCKER.SPECIAL_BLOCK_SEMANTIC_MISMATCH,

    CMD_GREAT_RAMPART_PROJECT: DOMAIN_ACTION_MIGRATION_BLOCKER.PROJECT_DOMAIN_MISSING,
    CMD_GRANARY_NETWORK: DOMAIN_ACTION_MIGRATION_BLOCKER.PROJECT_DOMAIN_MISSING,
    CMD_INDUSTRIAL_ROAD: DOMAIN_ACTION_MIGRATION_BLOCKER.PROJECT_DOMAIN_MISSING,
    CMD_IRRIGATION_NETWORK: DOMAIN_ACTION_MIGRATION_BLOCKER.PROJECT_DOMAIN_MISSING,
    CMD_INDUSTRIAL_CLUSTER: DOMAIN_ACTION_MIGRATION_BLOCKER.PROJECT_DOMAIN_MISSING,

    CMD_ABANDONED_SETTLEMENT: DOMAIN_ACTION_MIGRATION_BLOCKER.EXPLORATION_RESOLVER_OWNERSHIP_PENDING
});
...
function resolveDomainActionMigrationBlocker(cardId) {
    return DOMAIN_ACTION_MIGRATION_BLOCKER_BY_ID[cardId] || null;
}
