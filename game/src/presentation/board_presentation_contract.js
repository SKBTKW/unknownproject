...
function toCellDto(cell) {
    ...
    return {
        ...
        productionStatus: cell.productionStatus ?? null,
        productionScope: cell.productionScope ?? null,
        blockProduction: cloneJsonSafe(cell.blockProduction ?? null),
        blockProductionPrimary: Boolean(cell.blockProductionPrimary),
