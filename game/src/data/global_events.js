...
export const GLOBAL_EVENTS_MASTER = [
    ...
    },
    {
        ...
        conditions: [{ type: "STAGE_AT_LEAST", value: 2 }, { type: "TERRAIN_COUNT_AT_LEAST", terrain: "PLAINS", value: 6 }], effects: [{ type: "PRODUCTION_MULTIPLIER", target: "PLAINS_FOOD", value: 0.60 }], endEffects: []
    },
    {
        id: "EVENT_NEW_GENERATION", category: "SOCIETY", nameKey: "EVENT_NEW_GENERATION_NAME", descKey: "EVENT_NEW_GENERATION_DESC", icon: "👥", minStage: 2, duration: 3, baseWeight: 60, importance: "MAJOR",
        conditions: [{ type: "STAGE_AT_LEAST", value: 2 }, { type: "RESOURCE_AT_LEAST", resource: "food", value: 80 }, { type: "HISTORY_CHECK", checkType: "NO_FOOD_DEFICIT_RECENT", turns: 3 }], effects: [{ type: "OFFERING_WEIGHT_TAG_BOOST", tag: "POPULATION", multiplier: 1.8 }], endEffects: []
    },
    {
        id: "EVENT_CRAFTSMAN_BOOM", category: "SOCIETY", nameKey: "EVENT_CRAFTSMAN_BOOM_NAME", descKey: "EVENT_CRAFTSMAN_BOOM_DESC", icon: "🔨", minStage: 2, duration: 3, baseWeight: 60, importance: "MAJOR",
        conditions: [{ type: "STAGE_AT_LEAST", value: 2 }, { type: "SOCKET_FOUND", category: "STONE" }], effects: [{ type: "OFFERING_WEIGHT_TAG_BOOST", tag: "CONSTRUCTION", multiplier: 1.8 }], endEffects: []
    },
    {
        id: "EVENT_BOUNTIFUL_SEASON", category: "OPPORTUNITY", nameKey: "EVENT_BOUNTIFUL_SEASON_NAME", descKey: "EVENT_BOUNTIFUL_SEASON_DESC", icon: "🌾", minStage: 1, duration: 3, baseWeight: 80, importance: "MAJOR",
        conditions: [{ type: "STAGE_AT_LEAST", value: 1 }, { type: "TERRAIN_COUNT_AT_LEAST", terrain: "PLAINS", value: 4 }], effects: [{ type: "PRODUCTION_MULTIPLIER", target: "PLAINS_FOOD", value: 1.25 }],
        endEffects: [{ type: "EVENT_WEIGHT_MODIFIER", targetTag: "EVENT_NEW_GENERATION", multiplier: 2.0, expiry: { type: "NEXT_GLOBAL_EVENT" } }]
    },
    {
...
if (typeof window !== "undefined") window.GLOBAL_EVENTS_MASTER = GLOBAL_EVENTS_MASTER;
if (typeof globalThis !== "undefined") globalThis.GLOBAL_EVENTS_MASTER = GLOBAL_EVENTS_MASTER;
