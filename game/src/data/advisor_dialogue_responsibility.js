...
export const ADVISOR_SCENE_RESPONSIBILITY = Object.freeze({
    ...
    [ADVISOR_SCENES.POST_TRIAL_ASSESSMENT]: duty(),
    [ADVISOR_SCENES.POST_TRIAL_MEANING]: reaction(),
    [ADVISOR_SCENES.POST_TRIAL_STAGE_PRELUDE]: duty(),
    [ADVISOR_SCENES.POST_TRIAL_POST_STAGE_COMMENT]: reaction(),
