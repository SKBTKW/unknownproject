...
(function(exports) {
    ...
    const MODAL_CSS = `
        ...
        .modal-system-strip-card {
            ...
            box-shadow: 0 20px 50px rgba(0, 0, 0, 0.9), 0 0 30px rgba(26, 188, 156, 0.25);
            border-radius: 14px;
            padding: 18px 24px;
            color: #ffffff;
        ...
        /* 🎬 ターン開始・試練アイキャッチ演出 (Eyecatch Strip) */
    ...
    class ModalSystem {
        ...
        static showConfirmDialog({ title, costText, descText, confirmLabel, cancelLabel, onConfirm, onCancel }) {
            ...
            const cText = costText ? `<div class="modal-system-cost-badge">Cost: ${costText}</div>` : '';
