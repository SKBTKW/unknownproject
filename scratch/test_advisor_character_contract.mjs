...
assert.equal(DEFAULT_ADVISOR_CHARACTER, ADVISOR_CHARACTERS.GENERAL_OLD_01);
...
// Current UI compatibility: both character definitions expose the legacy portrait aliases.
for (const character of characters) {
...
for (const character of characters) {
    ...
    if (character.id === 'staff_officer_female_01') {
