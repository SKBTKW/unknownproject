/* =============================================================
   scratch/strict_guard_linter.js
...
// 0. ユーザー事前Diff承認フラグ (.approved) の存在チェック
const approvedFlagPath = path.join('scratch', '.approved');
if (!fs.existsSync(approvedFlagPath)) {
    console.error('❌ [ERROR] ユーザーからの事前Diff承認が得られていません (scratch/.approved が未生成です)。');
